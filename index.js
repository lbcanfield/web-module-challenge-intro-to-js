...
Do the following:   
   ...
   HINT: no function required
*/
let firstThing = '1st Thing';
//let secondThing = '1st Thing';
let secondThing = 'not 1st Thing';
...
let compChoice = Math.floor(Math.random() * 10000000) % 3;
let userChoice = Math.floor(Math.random() * 10000000) % 3;
if (compChoice === 0)
{
  compChoice = 'rock';
}
